            ...
            <footer className={styles.footer10}>
                <div className={styles.container10}>
                    ...
                    <div className={styles.col10}>
                        ...
                        <p>
                            3rd Floor, Neelagiri Complex, Plot No. 36-C & 43-C,
                            Raghavendra Nagar Colony, Kondapur,
                            Serilingampally, Telangana 500084, India
                        </p>
                    </div>


                    <div className={styles.imageCol10}>
                        <img src="/prag1.png" alt="Footer Image" />
                    </div>
